...
2. Попросите их отправить имя пользователя, которое они указали при регистрации
3. Зайдите в раздел `Управление` -> `Сотрудники`
4. Нажмите кнопочку `Добавить`
5. Введите полученное имя пользователя и нажмите `Далее`

::: warning
Если вы получили ошибку `Мы не смогли найти пользователя...`, попросите сотрудника проверить, правильное ли имя пользователя он отправил. Он может проверить это [по этой ссылке](https://rustapp.io/client/profile), имя пользователя будет написано под ником.
:::
